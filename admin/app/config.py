...
class Settings:
    ...
    REQUEST_LOG_TABLE: str = os.getenv("REQUEST_LOG_TABLE", "YANTECH-YNP01-AWS-DYNAMODB-REQUEST-LOG-DEV")
    NOTIFICATION_METRICS_TABLE: str = os.getenv("NOTIFICATION_METRICS_TABLE", "YANTECH-YNP01-AWS-DYNAMODB-NOTIFICATION-METRICS-DEV")
